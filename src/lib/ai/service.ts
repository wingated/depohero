...
export const serverSideAI = {
  async analyzeTurns(depositionId: string) {
...
For each turn, identify the speaker (either the witness,"${deposition.witness_name}", the attorney conducting the deposition,"${deposition.deposition_conductor}", or the opposing counsel, "${deposition.opposing_counsel}") based on the content and context of what was said.
        ...
        properties: {
          turns: {
            ...
            items: {
              type: "object",
              properties: {
                speaker: { type: "string", "enum": [deposition.witness_name, deposition.deposition_conductor, deposition.opposing_counsel, "unknown"] },
